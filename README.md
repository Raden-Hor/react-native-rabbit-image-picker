...
If you are using react-native >= 0.60 use react-native-rabbit-image-picker version >= 0.25.0. Otherwise use version < 0.25.0.
...
```javascript
import ImagePicker from 'react-native-rabbit-image-picker';
```
