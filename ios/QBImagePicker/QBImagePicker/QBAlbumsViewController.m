...
- (IBAction)onClickManage:(UIButton *)sender {
    UIAlertController *actionSheet = [UIAlertController alertControllerWithTitle:@"" message:@"Select more photos or go to Settings to allow access to all photos." preferredStyle:UIAlertControllerStyleActionSheet];
    
    [actionSheet addAction:[UIAlertAction actionWithTitle:@"Cancel" style:UIAlertActionStyleCancel handler:^(UIAlertAction *action) {
            
    }]];
    
    [actionSheet addAction:[UIAlertAction actionWithTitle:@"Select More Photos" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
        if (@available(iOS 14, *)) {
    ...
    [actionSheet addAction:[UIAlertAction actionWithTitle:@"Allow Access to All Photos" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
